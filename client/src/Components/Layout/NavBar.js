    ...
    Wijaya Beach Hotel
          ...
          <>
            ...
            <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
             ...
             <li class="nav-item">
				<a style={{ display: userRole == "admin" ? "flex" : "none" , textDecoration:"none"}} class="nav-link" href="/" aria-current="page">Edit  Room</a>

             </li>   
              <li class="nav-item">
				<a style={{ display: userRole == "admin" ? "flex" : "none" , textDecoration:"none"}} class="nav-link" href="/" aria-current="page">Edit  Employee</a>
             </li>
              </div>
            </div>
          </div>
