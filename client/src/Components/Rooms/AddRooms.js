...
const AddRooms = () => {
    ...
    function HandleSubmit(e) {
        ...
        setRoom({
            RoomID: "", RoomType: "", RoomIMG: "", Description: "", Features: ""
        });
    }
                        ...
                        <form onSubmit={HandleSubmit}>
                            <div className='row py-3'>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <input name="RoomIMG" value={room.RoomIMG}
                                        onChange={onChangeInput} type="text" class="form-control" id="RoomIMG" placeholder='Enter IMG URL' required />
                                </div>
                            </div>
                            <div className='row py-3'>
                                <div class="col-md-12">
